...
CREATE TABLE `gamestate` (
  ...
  `xlocation` float DEFAULT NULL,
  `ylocation` float DEFAULT NULL,
  `zlocation` float DEFAULT NULL,
...
INSERT INTO `gamestate` VALUES (1,3,2,5,1),(2,3,2,5,1);
...
-- Dump completed on 2025-05-09 17:49:11
